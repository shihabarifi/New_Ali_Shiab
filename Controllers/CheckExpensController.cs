...
namespace POS.Controllers
{
    ...
    public class CheckExpensController : Controller
    {
        ...
        public CheckExpensController(ICheckExpens repo, IAccountingManual accountingManualRepo, IBank bankRepo,
            ICurrency currencyRepo, IExchangeRate exchangeRateRepo) // here the repository will be passed by the dependency injection.
        {
            _Repo = repo;
        ...
        public IActionResult Index(string sortExpression = "", string SearchText = "", int pg = 1, int pageSize = 5)
        {
            ...
            PaginatedList<CheckExpensVoucher> items = _Repo.GetItems(sortModel.SortedProperty, sortModel.SortedOrder, SearchText, pg, pageSize);
        ...
        public IActionResult Chequelist(string sortExpression = "", string SearchText = "", int pg = 1, int pageSize = 5)
        {
            ...
            PaginatedList<CheckExpensVoucher> items = _Repo.GetItemscheques(sortModel.SortedProperty, sortModel.SortedOrder, SearchText, pg, pageSize);
        ...
        {
            CheckExpensVoucher item = _Repo.GetItem(id);
        ...
        [HttpPost]
        public IActionResult Cheque(CheckExpensVoucher item)
        {
            ...
            try
            {
                ...
                item.IsDelete = 0;
                item.CreditAmountRly = item.DebittAmountRly;
                item.CreditAmountUdo = item.DebittAmountUdo;
                item.CheckExpendCheques = 1;
            ...
            else
            {
                ...
                TempData["SuccessMessage"] = "" + item.CheckExpensVoucherNumber + " Chequed Successfully";
        ...
        public IActionResult Stagelist(string sortExpression = "", string SearchText = "", int pg = 1, int pageSize = 5)
        {
            ...
            PaginatedList<CheckExpensVoucher> items = _Repo.GetItemsStagelist(sortModel.SortedProperty, sortModel.SortedOrder, SearchText, pg, pageSize);
        ...
        public IActionResult Stagelist(string No)
        {
            ...
            try
            {
                ...
                string bolret = _Procedures.ChexStages(No);
        ...
        {
            CheckExpensVoucher item = new CheckExpensVoucher();

    
            ViewBag.AccountList = GetAccounts();
            ViewBag.BankList = GetBanks();
            item.CheckExpensVoucherNumber = _Repo.GetNewEXNumber();
            item.FiscalYear = 7;
            item.SystemUsers = "6f94621c-3508-435c-98fe-c51cc63d076f";
            item.CheckStatus = 0;
            item.ChequesType = "يدوي";
            item.CheckExpendCheques = 0;
        ...
        [HttpPost]
        public IActionResult Create(CheckExpensVoucher item)
        {
            ...
            {
                TempData["SuccessMessage"] = "" + item.CheckExpensVoucherNumber + " Created Successfully";
                return RedirectToAction(nameof(Index));
            }
        }
        ...
        [HttpPost]
        public IActionResult Delete(CheckExpensVoucher item)
        {
            bool bolret = false;
            string errMessage = "";
            try
            ...
            {
                TempData["SuccessMessage"] = item.CheckExpensVoucherNumber + " Deleted Successfully";
        ...
        [HttpPost]
        public IActionResult Edit(CheckExpensVoucher item)
        {
            ...
            else
            {
                ...
                TempData["SuccessMessage"] = "" + item.CheckExpensVoucherNumber + " Modified Successfully";
                return RedirectToAction(nameof(Index));
            }
        }
