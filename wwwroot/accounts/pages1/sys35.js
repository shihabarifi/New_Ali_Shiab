...
$(function () {
    ...
    if (dataTablePermissions.length) {
        dt_permission = dataTablePermissions.DataTable({
            ...
            dom:
                '<"row mx-1"' +
                '<"col-sm-6 col-md-6"<"dt-action-buttons text-xl-end  text-md-end text-start d-flex align-items-center justify-content-md-between justify-content-center flex-wrap me-1"<"me-6"f>>>' +
                '>t' +
                '<"row mx-2"' +
            ...
            language: {
                sLengthMenu: '_MENU_',
                search: '',
                searchPlaceholder: '  بحث اسم الطلب..',
